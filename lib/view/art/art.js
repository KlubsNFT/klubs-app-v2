...
class Art {
    constructor() {
        ...
        Layout_1.default.current.content.append(this.container = (0, skydapp_browser_1.el)(".art-view", (0, skydapp_browser_1.el)("section", (0, skydapp_browser_1.el)("header", (0, skydapp_browser_1.el)("h2", "Crypto Art"), (0, skydapp_browser_1.el)(".tab-container", (0, skydapp_browser_1.el)("a.active", "All NFTs", { click: () => { ViewUtil_1.default.go("/arts"); } }), (0, skydapp_browser_1.el)("a", "On sale", { click: () => { ViewUtil_1.default.go("/arts/on-sale"); } }), (0, skydapp_browser_1.el)("a", "On Bid", { click: () => { ViewUtil_1.default.go("/arts/on-bid"); } }), (0, skydapp_browser_1.el)("a", "On Offerd", { click: () => { ViewUtil_1.default.go("/arts/offerd"); } })), (0, skydapp_browser_1.el)("hr")), this.artDisplay = (0, skydapp_browser_1.el)("article"))));
        this.init();
    }
    init() {
        this.loadProject();
